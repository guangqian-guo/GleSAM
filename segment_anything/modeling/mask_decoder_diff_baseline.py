...
class MaskDecoderDiffBase(nn.Module):
    def __init__(
        self,
        *,
        opt=None,
    ...
    def predict_masks(
        ...
        if clear:
            ...
            upscaled_embedding_diff = self.proj(src)
            noise_pred, noise = None, None
        ...
        return masks, iou_pred, upscaled_embedding if clear else upscaled_embedding_diff, robust_token, noise_pred, noise
