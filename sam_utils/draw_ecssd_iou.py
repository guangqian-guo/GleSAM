...
values = np.array([
    [0.6051, 0.6051,0.6051, 0.6051, 0.6051],
    [0.7467, 0.7809, 0.7844, 0.7518, 0.7393],
    [0.7150, 0.7150, 0.7150, 0.7150, 0.7150],
    [0.7824, 0.7890, 0.7976, 0.7759, 0.7729]
])
